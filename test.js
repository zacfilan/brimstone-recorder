...
import { Correction, BoundingBox, UnpredictableCorrection, ActualCorrection, AntiAliasCorrection } from "./rectangle.js";
            ...
            if (this._fileHandle.name.endsWith('.json')) {
                ...
                try {
                    ...
                    if (e instanceof SyntaxError) {
                        throw new Errors.TestLoadError(`Syntax error: ${e.stack}`, this._fileHandle.name);
                    }
                }
    ...
    * */
    ...
    <div class='card ${this.classes()} ${className}' data-index=${this.index}>
        ...
        if (this.test._playTree._stepBaseIndex !== undefined) {
            stepNumber += ` (${this.index + 1 + this.test._playTree._stepBaseIndex}/${PlayTree.stepsInZipNodes})`;
        }
